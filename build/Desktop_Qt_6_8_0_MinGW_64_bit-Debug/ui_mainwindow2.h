...
""));
        ...
        pushButton_AI__chat_page->setGeometry(QRect(0, 250, 130, 51));
...
""));
        ...
        pushButton_Document_query_page->setGeometry(QRect(0, 370, 130, 51));
...
""));
        ...
        pushButton_translate_page->setGeometry(QRect(0, 310, 130, 51));
...
""));
        ...
        QWidget::setTabOrder(pushButton_Daily_push_page, pushButton_AI__chat_page);
        QWidget::setTabOrder(pushButton_AI__chat_page, pushButton_translate_page);
        QWidget::setTabOrder(pushButton_translate_page, pushButton_Document_query_page);
        QWidget::setTabOrder(pushButton_Document_query_page, pushButton_Mine_page);
        QWidget::setTabOrder(pushButton_Mine_page, pushButton_pure);
        QWidget::setTabOrder(pushButton_pure, pushButton_selected);
        QWidget::setTabOrder(pushButton_selected, listWidget_interested);
        ...
        QWidget::setTabOrder(pushButton_delete_interested, comboBox_field_interested);
        ...
        QWidget::setTabOrder(comboBox_language, pushButton_search);
        ...
        QWidget::setTabOrder(lineEdit, comboBox_field);
        QWidget::setTabOrder(comboBox_field, scrollArea_history);
        QWidget::setTabOrder(scrollArea_history, textEdit_question);
    ...
    void retranslateUi(QMainWindow *MainWindow2)
    {
        ...
        pushButton_refresh_push->setText(QCoreApplication::translate("MainWindow2", "\346\215\242\344\270\200\346\211\271", nullptr));
